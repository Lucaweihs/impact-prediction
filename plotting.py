...
def plot_mape_per_count(preds, base_values, y, base_feature, name = None):
    ...
    s = [4720 * num_obs_for_value[k] / (1.0 * preds.shape[0]) for k in mape_for_value.keys()]
...
def plot_ape_scatter(preds, base_values, y, base_feature, name=None, heat_map=False):
